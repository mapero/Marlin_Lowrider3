...
#define STRING_CONFIG_H_AUTHOR "(V1 Engineering, Ryan, 6663608DL)" // "(none, default config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "V1CNC 6663608DL" // "3D Printer"
 ...
 */
#define Z_MIN_PROBE_PIN Z_MIN_PIN // -1
...
#define SHORT_BUILD_VERSION "6663608DL Custom"
